    ...
    public partial class FieldValue
    {
        internal Firebase.CloudFirestore.FieldValue ToNative()
        {
            return _fieldValueType switch
            {
                ...
                FieldValueType.ArrayUnion => Firebase.CloudFirestore.FieldValue.FromArrayUnion(_elements!.Select(x => (NSObject)x.ToNativeFieldValue()).ToArray()),
                FieldValueType.ArrayRemove => Firebase.CloudFirestore.FieldValue.FromArrayRemove(_elements!.Select(x => (NSObject)x.ToNativeFieldValue()).ToArray()),
