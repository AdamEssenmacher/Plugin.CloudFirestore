    ...
    internal static class FieldValueExtensions
    {
        ...
        public static object? ToFieldValue(this object? fieldValue, IDocumentFieldInfo fieldInfo)
        {
            return (fieldValue switch
            {
                ...
                NSArray array => DocumentObject.CreateAsList(info => info.DocumentInfo.Create(array)),
                NSDictionary dictionary => DocumentObject.CreateAsDictionary(info => info.DocumentInfo.Create(dictionary)),
